...
- **Filter files:** `data/filters/GALEX_GALEX.FUV.dat`, `data/filters/GALEX_GALEX.NUV.dat`
...
- **System:** AB
- **Filter files:** `data/filters/PAN-STARRS_PS1.{g,r,i,z,y,w}.dat`
...
- **Filter files:** `data/filters/UKIRT_UKIDSS.{Y,Z,J,H,K}.dat`
...
- **Filter files:** `data/filters/WISE_WISE.{W1,W2,W3,W4}.dat`
