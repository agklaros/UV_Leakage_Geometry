...
**Scripts in `scripts/` are reference implementations only.** They contain hardcoded paths to an old directory (`/home/agklaros/Documents/UV_Leakage_Geometry/`) and must not be run directly. Use the notebooks.
